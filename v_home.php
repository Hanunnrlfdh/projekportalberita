  ...
  <header id="header">
    <div class="container-fluid">
      <div id="logo" class="pull-left">
      	<a class="h5co"><img src="assets/STMIK MARDIRA.png" width="80px" height="80px"> </a>
  
    <h1>BERITA</h1>
     <h3>BERITA SEPUTAR ARTIS MANCA NEGARA</h3>
      ...
      <div id="introCarousel" class="carousel  slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active">
            <div class="carousel-background"><img src="<?php echo base_url().'theme/background/img/trend.jpg'?>" alt=""></div>
            <div class="carousel-container">
              <div class="carousel-content">
                <h2>Portal Berita </h2>
		   					<h3><p>Selamat Datang di berita terkini dan terupdate  </p></h3>
          ...
          <div class="carousel-item">
            <div class="carousel-background"><img src="<?php echo base_url().'theme/background/img/korea.jpg'?>" alt=""></div>
            <div class="carousel-container">
              <div class="carousel-content">
               <h2>Portal Berita</h2>
               <h3><p>Selamat Datang di berita terkini dan terupdate </p></h3>
          ...
          <div class="carousel-item">
            <div class="carousel-background"><img src="<?php echo base_url().'theme/background/img/pendidikan.jpg'?>" alt=""></div>
            <div class="carousel-container">
              <div class="carousel-content">
                <h2>Portal Berita</h2>
                <h3><p>Selamat Datang di berita terkini dan terupdate </p></h3>
          ...
          <div class="carousel-item">
            <div class="carousel-background"><img src="<?php echo base_url().'theme/background/img/politik.jpg'?>" alt=""></div>
            <div class="carousel-container">
              <div class="carousel-content">
               <h2>Portal Berita</h2>
               <h3><p>Selamat Datang di berita terkini dan terupdate dari</p></h3>
          ...
          <div class="carousel-item">
            <div class="carousel-background"><img src="<?php echo base_url().'theme/backround/img/japan.jpg'?>" alt=""></div>
            <div class="carousel-container">
              <div class="carousel-content">
               <h2>Portal Berita</h2>
               <h3><p>Selamat Datang di berita terkini dan terupdate </p></h3>
    ...
    <section id="about">
      <div class="container">
        ...
        <header class="section-header">
          <h3>PORTAL BERITA</h3>
          <p>Berita Seputar Dunia Yang lagi Trend
			</p>
        </header>
      ...
      <div class="container">
        ...
        <?php foreach($album->result() as $row):?>
          <div class="testimonial-item">
            <img src="<?php echo base_url().'assets/images/'.$row->album_cover?>" class="svt.img" alt="">
...
<!--            
  ...
  <footer id="footer">
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong>PORTAL BERITA </strong>. All Rights Reserved
      </div>
